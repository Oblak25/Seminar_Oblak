...
{
    public partial class ProductCategoryHList : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 11, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Extremely dangerous, fruit has red blood color and can squirt you to death.", 100m, 3, "https://i.pinimg.com/originals/6c/e8/50/6ce85072cd4b7e62d3904eec258b3aae.jpg", 20m, "Mibola" },
                    ...
                    { 13, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Grown by the Klinorian people.As soon as the plant grows to 20cm it starts shooting chemicals at whomever comes close.", 200m, 3, "https://i.pinimg.com/736x/b4/29/e7/b429e708c40a1fa66109bc092419cf10--art-in-nature-passion-flower.jpg", 55m, "Uriac" },
                    { 14, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Grown near black holes. The extreme gravity gives this fruit its tasty juice, hence the reason for buying it.", 400m, 3, "https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/345237f3-7d6b-418e-81b6-09202746aea0/d864ut1-39a83796-c716-4cfd-9098-4fc68682b664.jpg?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..uSzOcMsG71KI3fq7FwLfX84CRZ_vtqUJrO0Hp2EE7Tg", 120m, "Dessert Mangosteen" },
                    { 15, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "The most rare vegetable in the galaxy. It is grown on magnetars and the legend is that this fruit will give you wings", 800m, 3, "https://c8.alamy.com/comp/J1KGNH/3d-rendering-of-a-science-fiction-alien-plant-isolated-on-white-background-J1KGNH.jpg", 10m, "Ummeape" }
                });
